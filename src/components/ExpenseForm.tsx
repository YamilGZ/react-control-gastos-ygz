...
export default function ExpenseForm() {
    ...
    const { state, dispatch, remaingBudget } = useBudget()
    ...
    const handleSubmit = (e : FormEvent<HTMLFormElement>) => {
        ...
        if ( (expense.amount - previousAmount) > remaingBudget) {
            setError('El Gasto Supera el Presupesto')
            return
        }
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        >{state.editingId ? 'Actualizar Gasto' : 'Añade Gasto'}</legend>
